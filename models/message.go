...
// Message A Message contains a list of message templates representing the same message in different locales. The system will
...
func (m *Message) validateFallbackLocale(formats strfmt.Registry) error {
...
func (m *Message) validateTemplates(formats strfmt.Registry) error {
