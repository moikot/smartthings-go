...
// NewDeleteDeviceProfileParams creates a new DeleteDeviceProfileParams object
// with the default values initialized.
func NewDeleteDeviceProfileParams() *DeleteDeviceProfileParams {
	var ()
	return &DeleteDeviceProfileParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteDeviceProfileParamsWithTimeout creates a new DeleteDeviceProfileParams object
...
// NewDeleteDeviceProfileParamsWithContext creates a new DeleteDeviceProfileParams object
...
// NewDeleteDeviceProfileParamsWithHTTPClient creates a new DeleteDeviceProfileParams object
...
/*DeleteDeviceProfileParams contains all the parameters to send to the API endpoint
for the delete device profile operation typically these are written to a http.Request
*/
...
func (o *DeleteDeviceProfileParams) WithTimeout(timeout time.Duration) *DeleteDeviceProfileParams {
...
func (o *DeleteDeviceProfileParams) WithContext(ctx context.Context) *DeleteDeviceProfileParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DeleteDeviceProfileParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
