...
func (m *DeviceHealthEvent) validateReasonEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deviceHealthEventTypeReasonPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *DeviceHealthEvent) validateStatusEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deviceHealthEventTypeStatusPropEnum, true); err != nil {
		return err
	}
	return nil
}
