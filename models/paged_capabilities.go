...
func (m *PagedCapabilities) validateLinks(formats strfmt.Registry) error {
...
func (m *PagedCapabilities) validateItems(formats strfmt.Registry) error {
