...
func (o *GetScheduleBadRequest) GetPayload() *models.ErrorResponse {
	return o.Payload
}
...
func (o *GetScheduleTooManyRequests) GetPayload() *models.ErrorResponse {
	return o.Payload
}
...
func (o *GetScheduleDefault) GetPayload() *models.ErrorResponse {
	return o.Payload
}
