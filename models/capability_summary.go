...
func (m *CapabilitySummary) validateID(formats strfmt.Registry) error {
...
func (m *CapabilitySummary) validateStatusEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, capabilitySummaryTypeStatusPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *CapabilitySummary) validateVersion(formats strfmt.Registry) error {
