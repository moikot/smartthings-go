...
func (o *GetDevicesOK) GetPayload() *models.PagedDevices {
	return o.Payload
}
...
func (o *GetDevicesBadRequest) GetPayload() *models.ErrorResponse {
	return o.Payload
}
...
func (o *GetDevicesTooManyRequests) GetPayload() *models.ErrorResponse {
	return o.Payload
}
...
func (o *GetDevicesDefault) GetPayload() *models.ErrorResponse {
	return o.Payload
}
