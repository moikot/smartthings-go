...
type DeleteAllSubscriptionsParams struct {
	...
	*/
	...
	/*ModeID
	  Limit deletion to subscriptions for a particular mode or deletes parent if last mode
...
// WithModeID adds the modeID to the delete all subscriptions params
func (o *DeleteAllSubscriptionsParams) WithModeID(modeID *string) *DeleteAllSubscriptionsParams {
	o.SetModeID(modeID)
	return o
}

// SetModeID adds the modeId to the delete all subscriptions params
func (o *DeleteAllSubscriptionsParams) SetModeID(modeID *string) {
	o.ModeID = modeID
}
