...
func (m *PagedInstallConfigurations) validateLinks(formats strfmt.Registry) error {
...
func (m *PagedInstallConfigurations) validateItems(formats strfmt.Registry) error {
...
func (m *PagedInstallConfigurations) UnmarshalBinary(b []byte) error {
	var res PagedInstallConfigurations
