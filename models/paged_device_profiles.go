...
type PagedDeviceProfiles struct {
	...
	// items
	Items []*DeviceProfileResponse `json:"items"`
}
...
func (m *PagedDeviceProfiles) validateLinks(formats strfmt.Registry) error {
...
func (m *PagedDeviceProfiles) validateItems(formats strfmt.Registry) error {
