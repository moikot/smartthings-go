...
type ActionListItem struct {
	...
	Exclusion []*ExcludedActionItem `json:"exclusion"`
...
func (m *ActionListItem) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 AutomationAction
	if err := swag.ReadJSON(raw, &aO0); err != nil {
		return err
	}
	m.AutomationAction = aO0
...
func (m ActionListItem) MarshalJSON() ([]byte, error) {
	...
	aO0, err := swag.WriteJSON(m.AutomationAction)
	if err != nil {
		return nil, err
	}
...
// Validate validates this action list item
func (m *ActionListItem) Validate(formats strfmt.Registry) error {
	var res []error

	// validation for a type composition with AutomationAction
	if err := m.AutomationAction.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ActionListItem) validateComponent(formats strfmt.Registry) error {
...
func (m *ActionListItem) validateExclusion(formats strfmt.Registry) error {
...
func (m *ActionListItem) validateVisibleCondition(formats strfmt.Registry) error {
