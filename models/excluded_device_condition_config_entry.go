...
type ExcludedDeviceConditionConfigEntry struct {
	DeviceConfigEntry

	// To exclude specified automation in `exclude` when this item is selected by the user.
	Exclusion []*ExcludedConditionItemID `json:"exclusion"`
}
...
// Validate validates this excluded device condition config entry
...
func (m *ExcludedDeviceConditionConfigEntry) validateExclusion(formats strfmt.Registry) error {
...
func (m *ExcludedDeviceConditionConfigEntry) UnmarshalBinary(b []byte) error {
	var res ExcludedDeviceConditionConfigEntry
