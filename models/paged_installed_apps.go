...
func (m *PagedInstalledApps) validateLinks(formats strfmt.Registry) error {
...
func (m *PagedInstalledApps) validateItems(formats strfmt.Registry) error {
